...
def main():
    ...
    try:
        ...
        # is do_dashboard (:3808), and main() reaches that task only once the splash screen's
        # boot work is done (main/main.c:212-214,289-299).  So a reply in hand proves the
