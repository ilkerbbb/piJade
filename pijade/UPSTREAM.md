...
## 2. Divergence inventory (2026-09-14 23:35, at `6c2a69cc`)
...
| `main/slip39.h` | +102 / -0 | **New file** | The interface `main/slip39.c` exposes to the word-entry screens and the selfcheck: the share and word-count constants, the accumulator the entry screens fill share by share, and the error enum `slip39_error_message()` renders |
...
**Totals (measured 2026-09-14 at `6c2a69cc`):** 202 files, of which 175 are text
(+37392 / -2899) and 27 are binary fixtures, listed below rather than in the table because
